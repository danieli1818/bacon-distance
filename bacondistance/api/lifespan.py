...
from bacondistance.api.paths import TITLE_BASICS_IMDB_DATA_PATH, TITLE_PRINCIPALS_IMDB_DATA_PATH, \
    NAME_BASICS_IMDB_DATA_PATH, DATASET_PATH
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        if update_imdb_data():
            ...
            generate_db(TITLE_BASICS_IMDB_DATA_PATH, TITLE_PRINCIPALS_IMDB_DATA_PATH,
                        NAME_BASICS_IMDB_DATA_PATH, DATASET_PATH)
